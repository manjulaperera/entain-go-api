...
type RacingClient interface {
	...
	GetRaceById(ctx context.Context, in *GetRaceRequest, opts ...grpc.CallOption) (*GetRaceResponse, error)
}
...
func (c *racingClient) GetRaceById(ctx context.Context, in *GetRaceRequest, opts ...grpc.CallOption) (*GetRaceResponse, error) {
...
type RacingServer interface {
	...
	// Get race details by id
	GetRaceById(context.Context, *GetRaceRequest) (*GetRaceResponse, error)
...
func (UnimplementedRacingServer) GetRaceById(context.Context, *GetRaceRequest) (*GetRaceResponse, error) {
...
func _Racing_GetRaceById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RacingServer).GetRaceById(ctx, req.(*GetRaceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
